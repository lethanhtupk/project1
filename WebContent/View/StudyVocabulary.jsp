...
<div class="container">
	...
	<div class="row">
		...
		<div class="page-header">
				<h1>
				Danh sách bài tập hướng dẫn từ vựng:
			</h1>
		</div>
		</div>
	</div>
  ...
  <!-- /. PAGE TITLE-->
	...
	<c:forEach items="${listvgl}" var="list">
	
	
		<div class="span6">
			<div class="media">
			<form action="StudyVocabularyController?vocabularyguidelineid=${list.vocabularyguidelineid}" method="POST">
				 <a href="#" class="pull-left"><img src="ImageAudioVocab/${list.vocabularyimage}" style="height:150px; width:250px" class="media-object" alt='not found image' /></a>
			...
			<div class="pagination">
				<ul>
					<c:if test="${numberpage==1}">
						  ...
						  <li ><a href="StudyVocabularyController?pageid=${numberpage+1}">Next</a></li>
					</c:if>
					
					<c:if test="${numberpage==maxpageid}">
						  <li><a href="StudyVocabularyController?pageid=${numberpage- 1}">Prev</a></li>
