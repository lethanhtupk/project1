...
<div class="container">
	...
	<div class="row">
		...
		<div class="page-header">
			...
			<h2 style="color:red">
				<%= request.getAttribute("msgerrorDoingTest") !=null? request.getAttribute("msgerrorDoingTest"):" " %>
			</h2>
		</div>
		</div>
	</div>
  ...
  <!-- /. PAGE TITLE-->
	...
	<c:forEach items="${listFullExamToeic}" var="list">
	
	
		<div class="span6">
			<div class="media">
			
			<form action="DoingFullExamToeic?examinationid=${list.examinationid}&memberid=<%= session.getAttribute("memberid") %>" method="POST">
			
				 <a href="#" class="pull-left"><img src="ImageUpload/${list.examinationimage}" height="200px" width="200px" class="media-object" alt='not found image' /></a>
			...
			<div class="pagination">
				<ul>
					<c:if test="${numberpage==1}">
						  ...
						  <li ><a href="DisplayListFullExamToeic?pageid=${numberpage+1}">Next</a></li>
					</c:if>
					
					<c:if test="${numberpage==maxpageid}">
						  <li><a href="DisplayListFullExamToeic?pageid=${numberpage- 1}">Prev</a></li>
						  <li class="disabled"><a href="#">Next</a></li>
					</c:if>
					
					<c:if test="${numberpage>1 && numberpage< maxpageid}">
						  <li ><a href="DisplayListFullExamToeic?pageid=${numberpage- 1}">Prev</a></li>
						  <li ><a href="DisplayListFullExamToeicr?pageid=${numberpage+1}">Next</a></li>
					</c:if>
				</ul>
			</div>	
