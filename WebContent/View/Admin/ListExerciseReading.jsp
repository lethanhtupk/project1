...
<!-- header -->
	...
	<!-- Start main content -->
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="ative">List Exercise Reading</li>
					...
					<div class="page-content">
						...
						<!-- Content cua bai grammar -->
															<a class="green" href="ExReadingAddContent?readexerciseid=${list.readexerciseid}">
								...
								<!-- 	<form action = "VocabularyAddAudioImage" method="GET">
										<div class="col-xs-2">
		...
		<form action="InsertExReadingName" method="POST">
			    ...
			    <div class="modal-dialog">
			      ...
			      <div class="modal-content">
			        <div class="modal-header">
			          ...
			          <h4 class="modal-title">Add name of Exercise Reading</h4>
			        </div>
			        
			        <div class="modal-body">
			       		<input type="text" id="form-field-1-1" placeholder="Add name here..." class="form-control"  name="readname"/>
			        </div>
