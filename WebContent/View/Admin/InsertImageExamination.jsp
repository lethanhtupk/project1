...
<title>Insert Image for Exam</title>
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form  name="FormAddImage" action="UploadExamImage?examinationid=<%=request.getAttribute("examinationid")%>" method = "POST" enctype="multipart/form-data">
												<fieldset>
													...
													<%=request.getAttribute("msExaminationUpfile")!=null?request.getAttribute("msExaminationUpfile") :" " %>
													</label>
