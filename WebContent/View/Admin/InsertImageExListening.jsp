...
<title>Insert Image for Ex-Listening</title>
									...
									<div class="widget-body">
										<div class="widget-main">
											<h4 class="header blue lighter bigger">
												...
												Add Image for Ex Listening
											</h4>

											<div class="space-6"></div>

											<form  name="FormAddImage" action="UploadExListeningImage?listenexerciseid=<%=request.getAttribute("listenexerciseid")%>" method = "POST" enctype="multipart/form-data">
												<fieldset>
														
													<label class="block clearfix">
													<!-- check loi <h4><%= request.getAttribute("msInsertExamName") %></h4>-->
													
													
													<%=request.getAttribute("msUploadImageExListening")!=null?request.getAttribute("msUploadImageExListening") :" " %>
													</label>
													
													<label class="block clearfix">
													<b class="blue lighter bigger">Add file image: </b>
