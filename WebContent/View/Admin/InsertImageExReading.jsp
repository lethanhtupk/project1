...
<title>Insert Image for Ex-Reading</title>
									...
									<div class="widget-body">
										<div class="widget-main">
											<h4 class="header blue lighter bigger">
												...
												Add Image for Ex Reading
											</h4>

											<div class="space-6"></div>

											<form  name="FormAddImage" action="UploadExReadingImage?readexerciseid=<%=request.getAttribute("readexerciseid")%>" method = "POST" enctype="multipart/form-data">
												<fieldset>
													...
													<%=request.getAttribute("msUploadImageExReading")!=null?request.getAttribute("msUploadImageExReading") :" " %>
													</label>
