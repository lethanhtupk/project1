...
<title>Danh sách các bài ngữ pháp</title>
...
<body class="no-skin">
	...
	<!-- End Menu bar -->
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li><a>Grammar Manage</a></li>
							<li class="ative">List Grammar</li>
					...
					<div class="page-content">
							...
							<div class="col-xs-12">
								...
								<div class="row">
									...
									<!--  check lỗi -->
								<!--	<h1>so phan tu: <%=request.getAttribute("sophantucualist") %></h1> -->
						...
						<!-- Content cua bai grammar -->
															<a class="green" href="GrammarGuidelineAddContentforward?id=${list.grammarguidelineid}">
														...
														<td class="center">
															<a class="red" href="GrammarGuidelineDeleteContent?grammarguidelineid=${list.grammarguidelineid}">
		...
		<!-- Create modal -->
		<form action="InsertGguidelineName" method="POST">
			    ...
			    <div class="modal-dialog">
			      ...
			      <div class="modal-content">
			        <div class="modal-header">
			          ...
			          <h4 class="modal-title">Add name of Grammar</h4>
			        </div>
			        
			        <div class="modal-body">
			       		<input type="text" id="form-field-1-1" placeholder="Add name here..." class="form-control"  name="grammarname"/>
			        </div>
