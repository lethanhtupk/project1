...
<title>Add content Examinaiton</title>
									...
									<div class="widget-body">
										<div class="widget-main">
											<h4 class="header blue lighter bigger">
												...
												Add Content for Exam
											</h4>

											<div class="space-6"></div>

								<form  name="FormAddImage" action="ExaminationAddContent?examinationid=<%=request.getAttribute("examinationid")%>" method = "POST" enctype="multipart/form-data">
												<fieldset>
														
													<label class="block clearfix">
												<!--  	imsert:  <h4><%= request.getAttribute("messageInsert") %></h4>-->
													
													<%=request.getAttribute("msExaminationUpfileExcel")!=null?request.getAttribute("msExaminationUpfileExcel") :" " %>
													</label>
