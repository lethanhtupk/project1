...
<title>Add content Ex-Listening</title>
									...
									<div class="widget-body">
										<div class="widget-main">
											<h4 class="header blue lighter bigger">
												...
												Add Content for Ex-Listening
											</h4>

											<div class="space-6"></div>

								<form  name="FormAddImage" action="ExListeningAddContent?listenexerciseid=<%=request.getAttribute("listenexerciseid")%>" method = "POST" enctype="multipart/form-data">
												<fieldset>
														
													<label class="block clearfix">
												<!--  	imsert:  <h4><%= request.getAttribute("messageInsert") %></h4>-->
													
													<%=request.getAttribute("msListeningUpfileExcel")!=null?request.getAttribute("msListeningUpfileExcel") :" " %>
													</label>
													
													<label class="block clearfix">
													<b class="blue lighter bigger">Add file .xlsx: </b>
