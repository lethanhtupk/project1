...
<title>Insert Image for Grammar</title>
									...
									<div class="widget-body">
										<div class="widget-main">
											<h4 class="header blue lighter bigger">
												...
												Add Image for Grammar 
											</h4>

											<div class="space-6"></div>

											<form  name="FormAddImage" action="UploadGGlineImage?grammarguidelineid=<%=request.getAttribute("grammarguidelineid")%>" method = "POST" enctype="multipart/form-data">
												<fieldset>
