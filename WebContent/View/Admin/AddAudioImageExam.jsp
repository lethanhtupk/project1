...
<title>Add Audio && Image for Exam</title>
									...
									<div class="widget-body">
										<div class="widget-main">
											<h4 class="header blue lighter bigger">
												...
												Add Audio && Image for Exam
											</h4>

											<div class="space-6"></div>

								<form  name="FormAddImage" action="ExamAddAudioImage" method = "POST" enctype="multipart/form-data">
												<fieldset>
													<label class="block clearfix">
														<%=request.getAttribute("msAddAudioImageExam")!=null?request.getAttribute("msAddAudioImageExam"):" "%>
													</label>
