...
<title>List Vocabulary Manage</title>
...
<!-- header -->
	...
	<!-- Start main content -->
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li><a>Vocabulary Manage</a></li>
							<li class="ative">List Vocabulary</li>
					...
					<div class="page-content">
						...
						<!-- Content cua bai grammar -->
															<a class="green" href="VocabularyAddContent?vocabularyguidelineid=${list.vocabularyguidelineid}">
									...
									<div class="row">
										...
										<div class="col-xs-2">
											<a href="VocabularyAddAudio" class="btn btn-white btn-info btn-bold" >
												<i class="ace-icon fa fa-floppy-o bigger-120 blue"></i>
												Add Image & Audio
											</a>
										</div>
		...
		<form action="InsertVocabularyName" method="POST">
			    ...
			    <div class="modal-dialog">
			      ...
			      <div class="modal-content">
			        <div class="modal-header">
			          ...
			          <h4 class="modal-title">Add name of Vocabulary</h4>
			        </div>
			        
			        <div class="modal-body">
			       		<input type="text" id="form-field-1-1" placeholder="Add name here..." class="form-control"  name="vocabularyname"/>
			        </div>
