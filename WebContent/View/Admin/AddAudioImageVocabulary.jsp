...
<title>Add Audio && Image for Vocabulary</title>
									...
									<div class="widget-body">
										<div class="widget-main">
											<h4 class="header blue lighter bigger">
												...
												Add Audio-Image Vocabulary
											</h4>

											<div class="space-6"></div>

								<form  name="FormAddImage" action="VocabularyAddAudio" method = "POST" enctype="multipart/form-data">
												<fieldset>
													<label class="block clearfix">
														<%=request.getAttribute("msAddAudioImageVocabulary")!=null?request.getAttribute("msAddAudioImageVocabulary"):" "%>
													</label>
