...
<title>Add content Ex-Reading</title>
									...
									<div class="widget-body">
										<div class="widget-main">
											<h4 class="header blue lighter bigger">
												...
												Add Content for Ex-Reading
											</h4>

											<div class="space-6"></div>

								<form  name="FormAddImage" action="ExReadingAddContent?readexerciseid=<%=request.getAttribute("readexerciseid")%>" method = "POST" enctype="multipart/form-data">
												<fieldset>
														
													<label class="block clearfix">
												<!--  	imsert:  <h4><%= request.getAttribute("messageInsert") %></h4>-->
													
													<%=request.getAttribute("msExReadingUpfileExcel")!=null?request.getAttribute("msExReadingUpfileExcel") :" " %>
													</label>
