...
<title>Insert Image for Vocabulary</title>
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form  name="FormAddImage" action="UploadVocabularyImage?vocabularyguidelineid=<%=request.getAttribute("vocabularyguidelineid")%>" method = "POST" enctype="multipart/form-data">
												<fieldset>
													...
													<%=request.getAttribute("msVocabUploadImage")!=null?request.getAttribute("msVocabUploadImage") :" " %>
													</label>
