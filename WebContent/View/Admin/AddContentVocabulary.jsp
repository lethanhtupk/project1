...
<title>Add Content Vocabulary</title>
									...
									<div class="widget-body">
										<div class="widget-main">
											<h4 class="header blue lighter bigger">
												...
												Add Content for Vocabulary
											</h4>

											<div class="space-6"></div>

								<form  name="FormAddImage" action="VocabularyAddContent?vocabularyguidelineid=<%=request.getAttribute("vocabularyguidelineid")%>" method = "POST" enctype="multipart/form-data">
												<fieldset>
														
													<label class="block clearfix">
												<!--  	imsert:  <h4><%= request.getAttribute("messageInsert") %></h4>-->
													
													<%=request.getAttribute("msVocabUpfileExcel")!=null?request.getAttribute("msVocabUpfileExcel") :" " %>
													</label>
													
													<label class="block clearfix">
													<b class="blue lighter bigger">Add file .xls: </b>
